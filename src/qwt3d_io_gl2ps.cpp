...
bool VectorWriter::operator()(Plot3D *plot, QString const &fname)
{
    ...
    QString producer = QString("QwtPlot3D ") + version + ", (C) 2002";
    ...
    while (state == GL2PS_OVERFLOW) {
        bufsize += 2 * 1024 * 1024;
        gl2psBeginPage(QWT3DLOCAL8BIT(fname),
...
GLint Qwt3D::drawDeviceText(const char *str,
                            const char *fontname,
                            int fontsize,
                            Triple pos,
                            RGBA /*rgba*/,
